...
CGUISettings::CGUISettings(void)
{
  ...
  AddInt(4, "cachevideo.lan", 14027, 2048, 0, 256, 32768, SPIN_CONTROL_INT_PLUS, MASK_KB, TEXT_OFF);
  AddInt(5, "cachevideo.internet", 14028, 4096, 0, 256, 32768, SPIN_CONTROL_INT_PLUS, MASK_KB, TEXT_OFF);
  ...
  AddInt(9, "cacheaudio.internet", 14032, 256, 0, 256, 32768, SPIN_CONTROL_INT_PLUS, MASK_KB, TEXT_OFF);
  ...
  AddInt(14, "cacheunknown.internet", 14060, 4096, 0, 256, 32768, SPIN_CONTROL_INT_PLUS, MASK_KB, TEXT_OFF);
